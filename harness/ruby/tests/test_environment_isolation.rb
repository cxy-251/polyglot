...
A.case("runner-owned user and package directories exclude persistent state") do
...
A.case("runner-owned locale and time zone make process defaults reproducible") do
