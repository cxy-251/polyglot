...
A.case("runner clears user code injection and child state cannot escape its process") do
...
A.case("child load paths and feature caches remain process-local") do
