...
A.case("positional, keyword, rest and block parameters bind through distinct channels") do
...
A.case("splat conversion distinguishes nil, absent to_a and malformed to_a") do
...
A.case("anonymous forwarding preserves all argument channels and reports forwarding parameters") do
  A.equal(
    [1, 2, [], 3, 4, {}, 2],
