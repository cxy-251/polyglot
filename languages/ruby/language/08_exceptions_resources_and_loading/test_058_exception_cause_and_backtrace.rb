...
A.case("raising during rescue links the active exception as cause and captures locations") do
...
A.case("set_backtrace accepts an explicit diagnostic location list") do
