...
A.case("ruby -e receives positional ARGV separately from standard input") do
...
A.case("-I extends the load path and -r requires a feature before the main expression") do
...
A.case("syntax, warning and frozen-literal flags alter independent command-line contracts") do
...
A.case("OptionParser converts declared types, returns operands and rejects invalid values") do
  options = {count: 1}
