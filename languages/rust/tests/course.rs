#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_001_rustc_cargo_package_crate_and_targets.rs"]
mod course_001;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_002_library_binary_unit_and_integration_tests.rs"]
mod course_002;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_003_doc_tests_selection_and_ignored_tests.rs"]
mod course_003;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_004_features_and_conditional_compilation.rs"]
mod course_004;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_005_profiles_workspace_and_metadata.rs"]
mod course_005;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_006_cargo_tree_and_dependency_graph.rs"]
mod course_006;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_007_formatting_and_clippy_workflow.rs"]
mod course_007;
#[path = "tooling_and_runtime/01_toolchain_crates_modules_and_testing/test_008_build_scripts_examples_and_benchmark_boundary.rs"]
mod course_008;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_009_bindings_mutability_and_shadowing.rs"]
mod course_009;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_010_scalars_tuples_arrays_and_inference.rs"]
mod course_010;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_011_expression_blocks_and_if.rs"]
mod course_011;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_012_match_if_let_and_let_else.rs"]
mod course_012;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_013_loops_labels_and_break_values.rs"]
mod course_013;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_014_while_for_and_into_iterator.rs"]
mod course_014;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_015_diverging_expressions_and_never_coercion.rs"]
mod course_015;
#[path = "language/02_bindings_types_expressions_and_control_flow/test_016_casts_and_checked_conversions.rs"]
mod course_016;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_017_move_semantics_and_ownership_transfer.rs"]
mod course_017;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_018_copy_clone_and_explicit_duplication.rs"]
mod course_018;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_019_shared_and_mutable_borrows.rs"]
mod course_019;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_020_reborrowing_and_exclusivity.rs"]
mod course_020;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_021_nonlexical_lifetimes_and_elision.rs"]
mod course_021;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_022_explicit_struct_and_method_lifetimes.rs"]
mod course_022;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_023_temporary_lifetimes_and_drop_scopes.rs"]
mod course_023;
#[path = "language/03_ownership_borrowing_and_lifetimes/test_024_partial_moves_and_move_out_restrictions.rs"]
mod course_024;
#[path = "language/04_structs_enums_patterns_and_modeling/test_025_named_tuple_and_unit_structs.rs"]
mod course_025;
#[path = "language/04_structs_enums_patterns_and_modeling/test_026_enums_option_and_result.rs"]
mod course_026;
#[path = "language/04_structs_enums_patterns_and_modeling/test_027_destructuring_and_match_ergonomics.rs"]
mod course_027;
#[path = "language/04_structs_enums_patterns_and_modeling/test_028_binding_modes_ref_and_at_patterns.rs"]
mod course_028;
#[path = "language/04_structs_enums_patterns_and_modeling/test_029_guards_and_exhaustive_matching.rs"]
mod course_029;
#[path = "language/04_structs_enums_patterns_and_modeling/test_030_non_exhaustive_boundaries.rs"]
mod course_030;
#[path = "language/04_structs_enums_patterns_and_modeling/test_031_discriminants_and_repr.rs"]
mod course_031;
#[path = "language/04_structs_enums_patterns_and_modeling/test_032_layout_and_niche_observations.rs"]
mod course_032;
#[path = "language/05_functions_closures_and_iterators/test_033_function_items_and_function_pointers.rs"]
mod course_033;
#[path = "language/05_functions_closures_and_iterators/test_034_closure_capture_modes.rs"]
mod course_034;
#[path = "language/05_functions_closures_and_iterators/test_035_move_closures_and_owned_state.rs"]
mod course_035;
#[path = "language/05_functions_closures_and_iterators/test_036_fn_fn_mut_and_fn_once.rs"]
mod course_036;
#[path = "language/05_functions_closures_and_iterators/test_037_higher_order_functions_and_partial_application.rs"]
mod course_037;
#[path = "language/05_functions_closures_and_iterators/test_038_iterator_laziness_and_adapters.rs"]
mod course_038;
#[path = "language/05_functions_closures_and_iterators/test_039_into_iterator_from_iterator_and_collect.rs"]
mod course_039;
#[path = "language/05_functions_closures_and_iterators/test_040_iterator_capabilities_and_early_termination.rs"]
mod course_040;
#[path = "language/06_traits_generics_and_dispatch/test_041_generic_functions_types_and_inference.rs"]
mod course_041;
#[path = "language/06_traits_generics_and_dispatch/test_042_traits_blanket_impls_and_orphan_rule.rs"]
mod course_042;
#[path = "language/06_traits_generics_and_dispatch/test_043_coherence_and_conflicting_implementations.rs"]
mod course_043;
#[path = "language/06_traits_generics_and_dispatch/test_044_associated_types_constants_and_default_methods.rs"]
mod course_044;
#[path = "language/06_traits_generics_and_dispatch/test_045_supertraits_and_static_dispatch.rs"]
mod course_045;
#[path = "language/06_traits_generics_and_dispatch/test_046_dyn_dispatch_and_dyn_compatibility.rs"]
mod course_046;
#[path = "language/06_traits_generics_and_dispatch/test_047_impl_trait_where_clauses_and_hrtb.rs"]
mod course_047;
