...
# pthread signal mask、pending 集合与同步 sigwait。
#
...
# sigwaitinfo 的发送者元数据与 sigtimedwait 的零超时轮询。
#
...
# set_wakeup_fd 把异步信号桥接到 I/O 事件循环。
#
...
# 处理器异常的主线程传播与 siginterrupt restart 模式。
#
...
# Python 的 SIGPIPE 策略与 BrokenPipeError。
#
...
# Linux pidfd_send_signal 使用稳定的进程引用。
#
