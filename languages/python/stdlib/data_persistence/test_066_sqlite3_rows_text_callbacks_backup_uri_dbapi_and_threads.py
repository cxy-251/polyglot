"""066｜``sqlite3.Row``、自定义 row factory 与 TEXT 解码。
...
# ``sqlite3.Connection`` 的 SQL function、aggregate 与执行回调。
#
...
# ``sqlite3`` SQL dump、online backup、URI 与连接锁等待。
#
...
# ``sqlite3`` DB-API 常量、异常层级、自定义 factory 与线程边界。
#
