...
def test_import_executes_module_and_returns_its_namespace(tmp_path, monkeypatch):
...
def test_module_attribute_is_live_but_from_import_binding_is_a_snapshot(tmp_path, monkeypatch):
...
def test_each_module_has_an_independent_global_namespace(tmp_path, monkeypatch):
...
def test_all_controls_star_import_not_direct_attribute_access(tmp_path, monkeypatch):
